...
export default function WarehouseHome() {
  ...
  return (
    <div className="flex flex-col min-h-dvh bg-gray-50">
      ...
      <main data-tour="destination-pickup-preparation" className="flex-1 p-4 pb-24 flex flex-col gap-4">
        {isLoading ? (
          <LoadingState variant="section" text="Memuat ringkasan..." />
        ) : (
          <>
            <div data-tour="destination-batch-receive" className="grid grid-cols-2 gap-3">
              {[
            ...
            <div data-tour="destination-delivery-preparation" className="bg-white rounded-2xl p-5 shadow-sm border border-gray-100 text-center">
