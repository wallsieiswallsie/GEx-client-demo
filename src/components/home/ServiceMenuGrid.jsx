    ...
    >
      <div className="relative mb-6 flex h-16 w-16 items-center justify-center overflow-visible rounded-[20px] bg-[#F3EEFF]">
        <img
          ...
          className="absolute -right-3 -bottom-6 h-14 w-14 object-contain transition-transform duration-200 drop-shadow-[0_20px_30px_rgba(99,102,241,0.18)] group-hover:scale-105"
        />
      </div>
