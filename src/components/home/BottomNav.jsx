...
import { Home, Package, PlayCircle, User, Database, FileText, Wallet, MessageSquareText } from 'lucide-react';
...
const NAV_ITEMS = [
  ...
  { id: 'feedbacks', icon: MessageSquareText, label: 'MASUKAN', path: '/feedbacks', roles: ['general_manager'] },
